...
function ready() {
    ...
    //newly
        ...
        var addbutton= document.getElementsByClassName('shop-item-button-input')[0]
     addbutton.addEventListener('click', addItemToShop)
    //
...
function addItemToShop(event){
    ...
    var cartRowContents = 
     `<div class="shop-item">
                    ...
                    <img class="shop-item-image" src="${itemSrc}">
